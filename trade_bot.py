...
bot=commands.AutoShardedBot(command_prefix=';',help_command=None,intents=intents)
...
async def on_ready():    
    ...
    channel=bot.get_channel(1254619896290213888) # wap channel:  1254619896290213888,715222394318356541
    print(channel)
